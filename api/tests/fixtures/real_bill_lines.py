...
CORPUS: list[tuple[str, dict]] = [
    ...
    ("ST STORAGE BOX 12X18 273.685 KGS per KGS 182",
     {"brand": "ST", "size": "12x18", "size_kind": "nxn", "weight_priced": True, "rate": 182.0}),
    ("GS DEEP DIBBA 10X14 43.630 KGS per KGS 308.5",
     {"brand": "GS", "size": "10x14", "weight_priced": True, "rate": 308.5}),
    ("C.B.KADAI 12X18 8.674 KGS per KGS 289",
     {"size": "12x18", "weight_priced": True, "rate": 289.0}),
    ("ST BUCKET 12X15 9.255 KGS per KGS 192",
     {"brand": "ST", "size": "12x15", "weight_priced": True, "rate": 192.0}),
    ("ST DHEGCHI 00X5 27.152 KGS per KGS 282",
     {"brand": "ST", "size": "00x5", "weight_priced": True, "rate": 282.0}),
    ("ST MILK POT DK 10X18 29.568 KGS per KGS 268.5",
     {"brand": "ST", "size": "10x18", "weight_priced": True, "rate": 268.5}),
    ("FLAT BOTTAM TOP 10X18 43.968 KGS per KGS 239",
     {"size": "10x18", "weight_priced": True, "rate": 239.0}),
    ("RAJAT TOP 29X32 8.814 KGS per KGS 392",
     {"size": "29x32", "weight_priced": True, "rate": 392.0}),

    # --- counter bill, mixed ---
    ("Hawkins 10 31X5 1 x 2445",
     {"brand": "Hawkins", "weight_priced": False, "qty": 1.0, "rate": 2445.0}),
    ("St Tray 18.60 x 450",
     {"weight_priced": True, "qty": 18.6, "rate": 450.0}),
    ("SS 16 16 1 x 2500",
     {"brand": "SS", "weight_priced": False, "qty": 1.0, "rate": 2500.0}),
    ("Hawkins 22 7 x 6006",
     {"brand": "Hawkins", "weight_priced": False, "qty": 7.0, "rate": 6006.0}),
    ("SINI B.Thali 13.970 x 270",
     {"brand": "SINI", "weight_priced": True, "qty": 13.97, "rate": 270.0}),
    ("Spoon 100 x 22.50",
     {"weight_priced": False, "qty": 100.0, "rate": 22.5}),

    # --- branded goods bill #1801, per PIECE ---
    ("Dhara Kettly 10cup 6PC 425",
     {"brand": "Dhara Kettle", "size": "10cup", "size_kind": "cup",
      "weight_priced": False, "qty": 6.0, "rate": 425.0}),
    ("Dhara Kettly 25cup 3PC 600",
     {"brand": "Dhara Kettle", "size": "25cup", "weight_priced": False,
      "qty": 3.0, "rate": 600.0}),
    ("Mintage 3499 5Ltr 1PC 1820",
     {"brand": "Mintage", "sku": "3499", "size": "5ltr", "size_kind": "litre",
      "weight_priced": False, "qty": 1.0, "rate": 1820.0}),
    ("Mintage 4899 10Ltr 1PC 2548",
     {"brand": "Mintage", "sku": "4899", "size": "10ltr",
      "weight_priced": False, "rate": 2548.0}),
    ("Mintage 4199 7.5Ltr 4PC 2183",
     {"brand": "Mintage", "sku": "4199", "size": "7.5ltr", "weight_priced": False,
      "qty": 4.0, "rate": 2183.0}),
]
